...
function showFirstAndLast(arr){
    let newArray = [];
    arr.forEach(value => {
        newArray.push(value.slice(0,1)+value.slice(-1))
    });
    return newArray
};
...
and the values as the number of times the vowel appears in the string. This function should be case insensitive so 
...
a new array with the value of the key with a name of "first" and the value of a key with the 
...
in the array that has the same value as the second parameter or 
